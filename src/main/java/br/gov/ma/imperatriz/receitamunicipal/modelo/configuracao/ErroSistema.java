package br.gov.ma.imperatriz.receitamunicipal.modelo.configuracao;
...
public class ErroSistema implements Serializable {
    ...
    private static final String PACOTE_PADRAO_SISTEMA = "br.gov.ma.imperatriz.receitamunicipal";
