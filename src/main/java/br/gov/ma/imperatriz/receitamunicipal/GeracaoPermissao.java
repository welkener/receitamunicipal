...
public class GeracaoPermissao {
    ...
    public void generate() {
        ...
        //Itbi
create(new Permissao("itbi", "Itbi", true), null);
create(new Permissao("itbi.create", "Cadastro de Itbi", "/itbi/createItbi.jsf", true), "itbi");
create(new Permissao("itbi.list", "Consulta de Itbi", "/itbi/listItbi.jsf", true), "itbi");
create(new Permissao("itbi.audit", "Auditoria de Itbi"), "itbi");
create(new Permissao("itbi.delete", "Exclusão de Itbi"), "itbi");

//Orgao
create(new Permissao("orgao", "Orgao", true), null);
create(new Permissao("orgao.create", "Cadastro de Orgao", "/orgao/createOrgao.jsf", true), "orgao");
create(new Permissao("orgao.list", "Consulta de Orgao", "/orgao/listOrgao.jsf", true), "orgao");
create(new Permissao("orgao.audit", "Auditoria de Orgao"), "orgao");
create(new Permissao("orgao.delete", "Exclusão de Orgao"), "orgao");

//Lei
create(new Permissao("lei", "Lei", true), null);
create(new Permissao("lei.create", "Cadastro de Lei", "/lei/createLei.jsf", true), "lei");
create(new Permissao("lei.list", "Consulta de Lei", "/lei/listLei.jsf", true), "lei");
create(new Permissao("lei.audit", "Auditoria de Lei"), "lei");
create(new Permissao("lei.delete", "Exclusão de Lei"), "lei");
